...
def from_settings(settings):
    ...
    if url:
        ...
        return redis.Redis(host=host, port=port, decode_responses=True, encoding='utf-8')
...
def from_settings_filter(settings):
    ...
    if url:
        ...
        return redis.Redis(host=host, port=port, db=db, decode_responses=True, encoding='utf-8')
